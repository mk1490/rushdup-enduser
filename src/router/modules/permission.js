...
const permissionRouter = {
  ...
  children: [
    {
      path: 'admin',
      component: () => import('@/view/components/Permission/Admin.vue'),
      name: 'PermissionAdmin',
      meta: { title: 'route.permission.admin', roles: ['admin'], noCache: true },
    },
    {
      path: 'editor',
      component: () => import('../../view/components/Permission/Editor.vue'),
      name: 'PermissionEditor',
      meta: { title: 'route.permission.editor', roles: ['editor'], noCache: true },
    },
    {
      path: 'visitor',
      component: () => import('@/view/components/Permission/Visitor.vue'),
