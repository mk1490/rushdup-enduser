                            ...
                            <template v-slot:activator="{props}">
                                <a
                                    style="cursor: pointer"
                                        @click="toggleNavbar"
                                        class="header-icon category-menu-toggle">
...
import ListItems from "@/view/layout/TheLayoutToolbar/Widgets/ListItems.vue";
...
::v-deep #two-level-menu .v-overlay__content {
    top: 60px !important;
